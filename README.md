...
<table>
  <tr>
    <td width="50%" valign="top">
      <h4>🚗 <a href="https://github.com/akriti1929/Smart-Autopark-Manager">Smart Autopark Manager</a></h4>
      <p>An intelligent parking automation and slot allocation system that tracks incoming vehicles, dynamically assigns available bays in real time, and prevents lot congestion.</p>
      <p>
        <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white" />
      ...
      <p>
        <a href="https://github.com/akriti1929/Smart-Autopark-Manager"><b>📁 View Repository</b></a>
      </p>
    </td>
    <td width="50%" valign="top">
      <h4>📋 <a href="https://github.com/akriti1929/Sprint-Board">Sprint-Board</a></h4>
      <p>Modern agile sprint management and Kanban platform built for team velocity, milestone tracking, and fluid task lifecycle execution.</p>
      <p>
      ...
      <ul>
        <li>Interactive drag-and-drop task state transitions</li>
        <li>Responsive, low-latency UI deployed on Vercel</li>
      </ul>
      <p>
        <a href="https://github.com/akriti1929/Sprint-Board"><b>📁 View Repository</b></a> •
  ...
  <tr>
    <td width="50%" valign="top">
      <h4>📄 <a href="https://github.com/akriti1929/AI-Resume-Analyser">AI Resume Analyzer</a></h4>
      <p>AI-powered applicant tracking and resume optimization engine that evaluates candidate resumes against job descriptions with targeted keyword and skill gap insights.</p>
      <p>
        <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white" />
        <img src="https://img.shields.io/badge/NLP-FF6F00?style=flat-square" />
        <img src="https://img.shields.io/badge/ATS_Scoring-22C55E?style=flat-square" />
      </p>
      <ul>
        <li>Automated NLP resume parsing and match scoring</li>
        <li>Actionable recommendations for keyword optimization</li>
      </ul>
      <p>
        <a href="https://github.com/akriti1929/AI-Resume-Analyser"><b>📁 View Repository</b></a>
      </p>
    </td>
    <td width="50%" valign="top">
      <h4>🍔 <a href="https://github.com/akriti1929/go4Food">go4Food Web App</a></h4>
      <p>Full-featured digital food ordering and discovery interface with real-time shopping cart state, menu categorization, and responsive layout.</p>
      <p>
        <img src="https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black" />
